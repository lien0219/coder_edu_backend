...
var (
	...
	ErrVideoURLEmpty                 = errors.New("视频链接不能为空")
	ErrVideoURLInvalid               = errors.New("视频链接格式无效")
	ErrVideoURLUnsupportedProtocol   = errors.New("不支持的视频链接协议")
	ErrVideoSourceInvalid            = errors.New("视频来源无效")
	...
	ErrInvalidKnowledgePoint         = errors.New("知识点不存在或已删除")
	ErrMaterialNotAccessible         = errors.New("该资料尚未解锁")
	ErrXPUpdateFailed                = errors.New("积分更新失败")
)
